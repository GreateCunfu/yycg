package com.yycg.system.process.context;
...
public class Config {
	 ...
	 * 返回值常量 String
	 */
	public static final String STRING_PACKAGE_PATH="java.lang.String";
	/**
	 * 返回值常量 返回的是ModelAndView
	 */
	public static final String MODELANDVIEW_PACKAGE_PATH="org.springframework.web.servlet.ModelAndView";
