...
public class ResourcesUtil implements Serializable {
	...
	public static void main(String[] args) {
		...
		System.out.println(locale.getDisplayLanguage()); //输出语言代码

		ResourceBundle rb = ResourceBundle.getBundle("config.messages", locale);

		String value = rb.getString("101");
		System.out.println(value);

		String fValue = MessageFormat.format(value, new Object[]{"你"});
		System.out.println(fValue);

		String messages = getValue("config.messages", "101", new Object[]{"你"});
